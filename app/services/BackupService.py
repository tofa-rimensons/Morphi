...
class BackupService:
    ...
    def push_all(self):
        ...
        for folder in folders_to_setup:
            self.push_folder(local_folder_path=folder[1], folder_id=folder[0])
